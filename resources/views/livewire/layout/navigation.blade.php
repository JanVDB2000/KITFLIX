    ...
    <div class="px-10">
        <div class="flex justify-between h-16">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                {{--<div class="mx-10">
                    <div class="mt-2">
                        <input type="text" name="name" id="name" class="block w-full rounded-full bg-netflixBlack px-4 py-1.5 text-sm outline outline-1 -outline-offset-1 outline-gray-300 placeholder:text-white focus:outline focus:outline-2 focus:-outline-offset-2 focus:outline-netflixRed" placeholder="Jane Smith">
                    </div>
                </div>--}}
